...
if(!class_exists('AQ_Page_Builder')) {
	class AQ_Page_Builder {
		...
		function __construct( $config = array()) {
			...
			$defaults['page_slug'] = __('distinctive-page-builder', 'aqpb-l10n');
		...
		function admin_enqueue() {
			...
			wp_register_style( 'aqpb-blocks-font-awesome', $this->url.'assets/stylesheets/font-awesome/css/font-awesome.css', array(), time(), 'all');
			wp_register_style( 'aqpb-blocks-pe-icon-7-stroke', $this->url.'assets/stylesheets/pe-icon-7-stroke/css/pe-icon-7-stroke.css', array(), time(), 'all');
			...
			// Enqueue 'em
			wp_enqueue_style('aqpb-blocks-font-awesome');
			wp_enqueue_style('aqpb-blocks-pe-icon-7-stroke');
		...
		function view_enqueue() {
			...
			// front-end css
			wp_register_style( 'dt-builder-front-end-css', $this->url.'assets/stylesheets/dt-builder-front-end.css', array(), time(), 'all');
			wp_enqueue_style('dt-builder-front-end-css');
